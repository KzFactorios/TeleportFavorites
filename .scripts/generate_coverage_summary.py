...
def main():
    report_path = "v:\\Fac2orios\\2_Gemini\\mods\\TeleportFavorites\\tests\\luacov.report.out"
    output_path = "v:\\Fac2orios\\2_Gemini\\mods\\TeleportFavorites\\tests\\coverage_summary.md"
