...
-- Loaded via deps.lua (mod root) and core/control/deps.lua (shim) so require("deps")
-- resolves whether the runtime searches from mod root or from core/control/ first.
