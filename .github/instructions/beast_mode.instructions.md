...
description: "Autonomous execution, planning logic, and instruction-adherence"
applyTo: "**/*"
---
...
3. **Todo List**: Create concrete steps. **Tag each step** with the intended file (e.g., `[ ] Step 1: Update storage schema in cache.lua`).
