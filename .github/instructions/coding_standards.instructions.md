...
- **Top-Level Requires**: All `require` at lines 1-10, alphabetical.
...
- **Sprites**: 
  - ✅: `utility/list_view`, `utility/close`, `utility/refresh`, `utility/arrow-up/down/left/right`.
  - ❌: `minus`, `plus`, `remove`, `add` (Do not exist).
